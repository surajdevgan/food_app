        ...
        child: Column(
          ...
          children: [
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          //rating num
                          Text(
                            "(" + widget.itemInfo!.item_rating.toString() + ")",
                            style: const TextStyle(
                              color: Colors.purpleAccent,
                            ),
                          ),
                      ...
                      //tags
                      Text(
                        widget.itemInfo!.item_tags!.toString().replaceAll("[", "").replaceAll("]", ""),
                        maxLines: 2,
                        overflow: TextOverflow.ellipsis,
                        style: const TextStyle(
                          fontSize: 16,
            ...
            Wrap(
              runSpacing: 8,
              spacing: 8,
              children: List.generate(widget.itemInfo!.item_size!.length, (index)
              {
                return Obx(
                      ()=> GestureDetector(
                    onTap: ()
                    ...
                    child: Container(
                      ...
                      child: Text(
                        widget.itemInfo!.item_size![index].replaceAll("[", "").replaceAll("]", ""),
                        style: TextStyle(
                          fontSize: 16,
